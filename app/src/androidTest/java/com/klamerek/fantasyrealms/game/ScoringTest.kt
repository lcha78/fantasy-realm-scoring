...
class ScoringTest {
    ...
    fun genie_with_4_players() {
        Player.all.add(Player("1", Game(wildfireDeluxe = false, phoenixDeluxe = false)))
        Player.all.add(Player("2", Game(wildfireDeluxe = false, phoenixDeluxe = false)))
        Player.all.add(Player("3", Game(wildfireDeluxe = false, phoenixDeluxe = false)))
        Player.all.add(Player("4", Game(wildfireDeluxe = false, phoenixDeluxe = false)))
        val game = Game(wildfireDeluxe = false, phoenixDeluxe = false)
        game.add(genie)
        game.calculate()
    ...
    fun deluxe_edition_wildfire() {
        val baseGame = Game(wildfireDeluxe = false, phoenixDeluxe = false)
        ...
        val deluxeEdition = Game(wildfireDeluxe = true, phoenixDeluxe = true)
    ...
    fun phoenix_deluxe_edition_blanked_with_flood() {
        val game = Game(wildfireDeluxe = true, phoenixDeluxe = true)
