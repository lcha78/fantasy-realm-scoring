...
class ScoringTest {
    ...
    fun genie_with_4_players() {
        Player.all.add(Player("1", Game(wildfireWithOutsiders = false, phoenixDeluxe = false)))
        Player.all.add(Player("2", Game(wildfireWithOutsiders = false, phoenixDeluxe = false)))
        Player.all.add(Player("3", Game(wildfireWithOutsiders = false, phoenixDeluxe = false)))
        Player.all.add(Player("4", Game(wildfireWithOutsiders = false, phoenixDeluxe = false)))
        val game = Game(wildfireWithOutsiders = false, phoenixDeluxe = false)
        game.add(genie)
        game.calculate()
    ...
    fun deluxe_edition_wildfire() {
        val baseGame = Game(wildfireWithOutsiders = false, phoenixDeluxe = false)
        ...
        val deluxeEdition = Game(wildfireWithOutsiders = true, phoenixDeluxe = true)
        deluxeEdition.add(wildfireWithOutsiders)
    ...
    fun phoenix_deluxe_edition_blanked_with_flood() {
        val game = Game(wildfireWithOutsiders = true, phoenixDeluxe = true)
